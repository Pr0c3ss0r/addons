...
function RefreshMenu(MenuName)
   ...
   tb_set_text('Menu_TB_'..MenuName, tb)

   x,y = tb_get_location('Menu_TB_'..MenuName)

   tb_set_location('Menu_cur_'..MenuName, x, y + _Menu.list[MenuName]['cur'] * 14)
   tb_set_text('Menu_cur_'..MenuName, _Menu.list[MenuName]['Core_Text'][_Menu.list[MenuName]['cur'] + _Menu.list[MenuName]['scr']])
end
...
function CreateMenu(MenuName, Caption, opt, x, y, mx, sub_key)
   ...
   tb_create('Menu_Caption_'..MenuName)
   tb_set_location('Menu_Caption_'..MenuName, x, y)
   tb_set_bg_color('Menu_Caption_'..MenuName, 180, 80, 110, 140)
   tb_set_color('Menu_Caption_'..MenuName, 250, 250, 250, 250)
   tb_set_bold('Menu_Caption_'..MenuName, 'true')
   tb_set_text('Menu_Caption_'..MenuName, Caption)
   tb_set_bg_visibility('Menu_Caption_'..MenuName, true)
   tb_set_font('Menu_Caption_'..MenuName, 'Courier New', 9)
   tb_set_visibility('Menu_Caption_'..MenuName, true)

   tb_create('Menu_TB_'..MenuName)
   tb_set_location('Menu_TB_'..MenuName, x, y+15)
   tb_set_bg_color('Menu_TB_'..MenuName, 140, 54, 43, 0)
   tb_set_color('Menu_TB_'..MenuName, 250, 250, 250, 250)
   tb_set_bold('Menu_TB_'..MenuName, 'true')
   tb_set_text('Menu_TB_'..MenuName, tb)
   tb_set_bg_visibility('Menu_TB_'..MenuName, true)
   tb_set_font('Menu_TB_'..MenuName, 'Courier New', 9)
   tb_set_visibility('Menu_TB_'..MenuName, true)

   tb_create('Menu_cur_'..MenuName)
   tb_set_bg_color('Menu_cur_'..MenuName, 155, 40, 40, 100)
   tb_set_color('Menu_cur_'..MenuName, 255, 255, 255, 255)
   tb_set_bold('Menu_cur_'..MenuName, 'true')
   tb_set_text('Menu_cur_'..MenuName, _Menu.list[MenuName]['Core_Text'][_Menu.list[MenuName]['cur']])
   tb_set_bg_visibility('Menu_cur_'..MenuName, true)
   tb_set_font('Menu_cur_'..MenuName, 'Courier New', 9)
   tb_set_visibility('Menu_cur_'..MenuName, false)


   tb_create('Menu_scr_'..MenuName)
   tb_set_bg_color('Menu_scr_'..MenuName, 140, 80, 80, 80)
   tb_set_color('Menu_scr_'..MenuName, 255, 0, 0, 0)
   tb_set_bold('Menu_scr_'..MenuName, 'true')
   tb_set_text('Menu_scr_'..MenuName, scr)
   tb_set_bg_visibility('Menu_scr_'..MenuName, true)
   tb_set_font('Menu_scr_'..MenuName, 'Courier New', 9)
   tb_set_visibility('Menu_scr_'..MenuName, false)


   tb_create('Menu_bar_'..MenuName)
   tb_set_bg_color('Menu_bar_'..MenuName, 255, 255, 255, 255)
   tb_set_color('Menu_bar_'..MenuName, 255, 0, 0, 0)
   tb_set_bold('Menu_bar_'..MenuName, 'true')
   tb_set_text('Menu_bar_'..MenuName, ' \\cr')
   tb_set_bg_visibility('Menu_bar_'..MenuName, true)
   tb_set_font('Menu_bar_'..MenuName, 'Courier New', 9)
   tb_set_visibility('Menu_bar_'..MenuName, false)
   ...
   _Menu.callback_event['onload_Menu.'..MenuName] = {
      ...
      fn = function(key) 
         ...
         local x2,y2 = tb_get_extents('Menu_TB_'..key)

         if x2 == 0 then  -- No graphic update yet.
            return true
         end

         local x,y = tb_get_location('Menu_TB_'..key)

         tb_set_location('Menu_bar_'..key, x, y)
         Move_Menu(key, x, y)

         tb_set_visibility('Menu_Caption_'..key, true)
         tb_set_visibility('Menu_TB_'..key, true)
         tb_set_visibility('Menu_cur_'..key, true)
         tb_set_visibility('Menu_scr_'..key, true)
         tb_set_visibility('Menu_bar_'..key, true)
   ...
   _Menu.list[MenuName]['close'] = function()
      write('closing menu')
      tb_delete('Menu_TB_'..MenuName)
      tb_delete('Menu_cur_'..MenuName)
      tb_delete('Menu_scr_'..MenuName)
      tb_delete('Menu_bar_'..MenuName)
      tb_delete('Menu_Caption_'..MenuName)
...
function Move_Menu(MenuName, x, y)
   local x1,y1 = tb_get_location('Menu_TB_'..MenuName)
   local x2,y2 = tb_get_extents('Menu_TB_'..MenuName)

   _Menu.list[MenuName]['x'] = x
   _Menu.list[MenuName]['y'] = y - 15

   tb_set_location('Menu_Caption_'..MenuName, x, y - 15)
   tb_set_location('Menu_TB_'..MenuName, x, y)
   tb_set_location('Menu_cur_'..MenuName, x, y + _Menu.list[MenuName]['cur'] * 14)

   tb_set_location('Menu_scr_'..MenuName, x + x2, y)
   local bar_x,bar_y = tb_get_location('Menu_bar_'..MenuName)
   bar_y = bar_y - y1
   tb_set_location('Menu_bar_'..MenuName, x + x2, y + bar_y)
end
...
function menu_mouse_event(ActionType, x, y, is_blocked)
   ...
   if ActionType == 512 then  --mouse move
      ...
      if _Menu._MenuPress ~= nil then
         ...
         x1,y1 = tb_get_location('Menu_TB_'.._Menu._MenuPress)
         x2,y2 = tb_get_extents('Menu_TB_'.._Menu._MenuPress)
         ...
         elseif _Menu._MenuPress_type == 'scroll' then
            xx1,yy1 = tb_get_location('Menu_bar_'.._Menu._MenuPress)
            xx2,yy2 = tb_get_extents('Menu_bar_'.._Menu._MenuPress)
            ...
            if _Menu._MenuPressY > yy1 and _Menu._MenuPressY < yy1 + yy2 then 
               ...
               tb_set_location('Menu_bar_'.._Menu._MenuPress, xx1, NewY)
   ...
   for key, val in pairs(_Menu.list) do
      x1,y1 = tb_get_location('Menu_TB_'..key)
      x2,y2 = tb_get_extents('Menu_TB_'..key)
...
function menu_event_unload()
   for key, val in pairs(_Menu.list) do
      tb_delete('Menu_TB_'..key)
      tb_delete('Menu_cur_'..key)
      tb_delete('Menu_scr_'..key)
      tb_delete('Menu_bar_'..key)
      tb_delete('Menu_Caption_'..key)
      _Menu.list[key] = nil
   end
end
